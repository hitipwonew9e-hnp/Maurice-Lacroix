  ...
  let zminna1 = {
    data() {
        return {
          imgArr1: [
            { name: 'Maurice Lacroix AIKON.1.jpg', title: 'фото 1' },
            { name: 'Maurice Lacroix AIKON.2.jpg', title: 'фото 1' },
            { name: 'Maurice Lacroix AIKON.3.jpg', title: 'фото 1' },
            { name: 'Maurice Lacroix AIKON.4.jpg', title: 'фото 1' },
        ],
            i1: 0,
...
let zminna2 = {
  data() {
      return {
        imgArr2: [
          { name: 'Maurice Lacroix AIKON Automatic.1.jpg', title: 'фото 1' },
          { name: 'Maurice Lacroix AIKON Automatic.2.jpg', title: 'фото 1' },
...
let zminna3 = {
    data() {
        return {
          imgArr3: [
            { name: 'Maurice Lacroix AIKON Venturer.1.jpg', title: 'фото 1' },
            { name: 'Maurice Lacroix AIKON Venturer.2.jpg', title: 'фото 1' },
...
let zminna4 = {
    data() {
        return {
          imgArr4: [
{ name: 'Maurice Lacroix ELIROS Date.1.jpg', title: 'фото 1' },
{ name: 'Maurice Lacroix ELIROS Date.2.jpg', title: 'фото 1' },
...
let zminna5 = {
      data() {
          return {
            imgArr5: [
                { name: 'Maurice Lacroix MASTERPIECE Square Wheel Retrograde.1.jpg', title: 'фото 1' },
                { name: 'Maurice Lacroix MASTERPIECE Square Wheel Retrograde.2.jpg', title: 'фото 1' },
...
let zminna6 = {
      data() {
          return {
            imgArr6: [
              { name: 'Maurice Lacroix PONTOS Chronograph.1.jpg', title: 'фото 1' },
              { name: 'Maurice Lacroix PONTOS Chronograph.2.jpg', title: 'фото 1' },
        ...
        data() {
            return {
              imgArr7: [
                ...
                { name: 'Maurice Lacroix PONTOS.1.jpg', title: 'фото 1' },
                { name: 'Maurice Lacroix PONTOS.2.jpg', title: 'фото 1' },
            ],
                i7: 0,
...
let zminna8 = {
    data() {
        return {
          imgArr8: [
            { name: 'Maurice Lacroix.1.jpg', title: 'фото 1' },
            { name: 'Maurice Lacroix.2.jpg', title: 'фото 1' },
